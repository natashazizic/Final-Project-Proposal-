...
The Florida Keys mangroves are one of the most diverse ecosystems, providing a multitude of resources, ecosystem services and mitigation against natural disasters such as hurricanes @kathi. Manatees are a key species in these ecosystems and we want to learn more about their reproduction patterns, if the ocean temperature prohibits manatees from birthing in these areas and what the preferred temperatures for births might be.
...
Due to climate change impacts, there has been a consistent increase in sea levels across the globe @vito. This trend is expected to continue as climate change worsens, and will likely have negative impacts on coastal regions @vito. One of these impacts is flooding events, which will become more frequent as sea levels rise @vito. There is a known relationship between these occurrences, but we do not yet understand its extent @tahe. A study published in 2020 predicted that there was an exponential relationship between sea levels and coastal flooding, meaning that as ocean levels slowly increase, coastal regions will experience extremely severe and abundant flooding events @tahe. Our study aims to dive deeper into this topic.
...
Regardless, coastal development is continuing globally @graci. It is important that we understand the causes for coastal erosion, so we can work towards preventing it @graci. Our goal is to understand how different land types will be affected, and what factors will have the biggest impact on erosion.
Some underlying causes come from climate and storms, ocean currents and tides, land use, and ecosystem types @labuz. By understanding which of these factors have the most significant impacts, we can make progress towards fixing this inevitable problem.
